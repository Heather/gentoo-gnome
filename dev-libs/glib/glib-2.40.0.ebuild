...
KEYWORDS="~amd64" 
#"~alpha ~amd64 ~arm ~hppa ~ia64 ~m68k ~mips ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86 ~amd64-fbsd ~sparc-fbsd ~x86-fbsd ~amd64-linux ~arm-linux ~x86-linux"

# FIXME: want libselinux[${MULTILIB_USEDEP}] - bug #480960
# block package dev-util/gdbus-codegen gdbus-codegen is part of dev-lib/glib-2.40.0
RDEPEND="
